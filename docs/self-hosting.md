...
for image in flowlens-api flowlens-web; do
  docker pull ghcr.io/motoki1996/$image:v0.3.0
  docker tag ghcr.io/motoki1996/$image:v0.3.0 registry.example.local/flowlens/$image:v0.3.0
  docker push registry.example.local/flowlens/$image:v0.3.0
done
...
```bash
docker load < flowlens-v0.3.0-images-amd64.tar.gz
docker compose up -d
```
